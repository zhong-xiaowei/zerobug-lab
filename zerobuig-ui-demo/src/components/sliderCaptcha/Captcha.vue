<template>
  <div v-show="show" class="captcha">
    <div v-if="this.type === 'SLIDER'" class="slider">
      ...
      <div class="slider-move">
        ...
        <div :style="moveStyles" class="slider-move-btn"
             ...
             @touchstart="sliderDown($event)"></div>
      </div>
      <div class="bottom">
        <div v-show="showClose" class="close-btn" @click="handleClose"></div>
    ...
    <!--      </div>-->
    <!--      <div id="word-click-content" class="content" @click="wordClick">-->
    <!--        <div id="bg-img-div" class="bg-img-div">-->
...
export default {
  ...
  props: {
     ...
     * 是否开启控制台日志
     */
    openLog: {type: Boolean, default: false}
  },
  data() {
    return {
  ...
  methods: {
    ...
    handleCheck() {
      ...
      this.$emit(VERIFY, this.data.id, this.trackData, data => {
        if (!data) {
